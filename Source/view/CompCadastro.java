...
public abstract class CompCadastro {
	...
	private void initialize() {
		...
		labelNome.setBounds(50, 30, 39, 15);
		textFieldNomeCadastro = new JTextField();
		textFieldNomeCadastro.setBounds(99, 25, 620, 24);
		labelDataNascimento = new JLabel("Data de Nascimento");
		labelDataNascimento.setBounds(729, 30, 137, 15);
		textFieldDataNascimento = new JFormattedTextField();
		textFieldDataNascimento.setBounds(876, 25, 98, 24);
		try {
		...
		labelRua.setBounds(250, 100, 26, 15);
		textFieldRua = new JTextField();
		textFieldRua.setBounds(286, 95, 300, 24);
		labelNumero = new JLabel("Nº");
		labelNumero.setBounds(596, 100, 17, 15);
		textFieldNumero = new JTextField();
		textFieldNumero.setBounds(623, 95, 60, 24);
		labelBairro = new JLabel("Bairro");
		labelBairro.setBounds(693, 100, 41, 15);
		textFieldBairro = new JTextField();
		textFieldBairro.setBounds(744, 95, 230, 24);
		labelCidade = new JLabel("Cidade");
		labelCidade.setBounds(50, 135, 47, 15);
		textFieldCidade = new JTextField();
		textFieldCidade.setBounds(107, 130, 200, 24);
		labelEstado = new JLabel("Estado");
		labelEstado.setBounds(317, 135, 46, 15);
		comboBoxEstado = new JComboBox<String>();
		comboBoxEstado.setModel(new DefaultComboBoxModel(EnumEstado.values()));
		comboBoxEstado.setBounds(373, 130, 62, 24);
		labelComplemento = new JLabel("Complemento");
		labelComplemento.setBounds(445, 135, 95, 15);
		textFieldComplemento = new JTextField();
		textFieldComplemento.setBounds(550, 130, 424, 24);
